...
public class Grid extends GameObject {
	...
	public void render(SpriteBatch sb) {
		...
		case TOWER:
		case GRASS:
			sb.draw(MyAtlas.MENU, this.position.x, this.position.y, this.size.x, this.size.y);
			break;
		case WATER:

			break;
		case PATH:
			sb.draw(MyAtlas.PATH_BROWN, this.position.x, this.position.y, this.size.x, this.size.y);
			break;
		default:
			break;
		}
