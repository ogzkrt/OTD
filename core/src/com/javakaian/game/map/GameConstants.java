...
public class GameConstants {
	...
	public static int ENEMY_SPEED = (int) GRID_WIDTH * (3 / 2);
	...
	public static int REMAINING_HEALTH = 30;
	...
	public static float DAMAGE_POS_Y = GameConstants.GRID_WIDTH / 4;
	public static float RANGE_POS_X = GameConstants.GRID_WIDTH * 4;
	public static float RANGE_POS_Y = GameConstants.GRID_WIDTH / 4;;
	public static float SPEED_POS_X = GameConstants.GRID_WIDTH * 7;
	public static float SPEED_POS_Y = GameConstants.GRID_WIDTH / 4;;

	public static float SCORE_POS_X = GameConstants.GRID_WIDTH * 10;
	public static float SCORE_POS_Y = GameConstants.GRID_WIDTH / 4;
	public static float MONEY_POS_X = GameConstants.GRID_WIDTH * 13;
	public static float MONEY_POS_Y = GameConstants.GRID_WIDTH / 4;
	...
	private static float boffset_x = -GRID_WIDTH * 2;
