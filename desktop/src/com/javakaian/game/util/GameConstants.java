...
public class GameConstants {
	...
	public static float PAUSE2X_ITEM_SIZE = GRID_WIDTH * (0.8f);
	...
	// FONT POSITIONS
	public static float OFFSET_Y = 0.375f;
	...
	public static float REMAINING_POS_Y = GameConstants.GRID_HEIGHT * (8.0f + OFFSET_Y);
	public static float ENEMY_NUM_POS_X = GameConstants.GRID_WIDTH * 13.8f;
	public static float ENEMY_NUM_POS_Y = GameConstants.GRID_HEIGHT * (7.0f + OFFSET_Y);

	private static final float boffset_x = -GRID_WIDTH * 1.7f;
